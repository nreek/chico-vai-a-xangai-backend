...
$cpt_film->supports([ 'title', 'editor', 'excerpt', 'thumbnail' ]);

$cpt_person = new CPT('person', new Label('Personalidade','Personalidades'));
$cpt_person->supports([ 'title', 'editor', 'excerpt', 'thumbnail' ]);

$cpt_colunistas = new CPT('colunistas', new Label('Colunista','Colunistas'));

$cpt_register = new CPTs();
$cpt_register->add($cpt_newsletter, $cpt_colunistas, $cpt_suggestion, $cpt_film, $cpt_person)->hook();
